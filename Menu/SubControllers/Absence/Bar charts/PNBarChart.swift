...
class PNBarChart: UIView {
    ...
    var strokeColor =  UIColor.red // UIColor(red: 77.0/255.0, green: 186.0/255.0, blue: 122.0/255.0, alpha: 1.0)
    var strokeColors: Array<Any>!
    var xLabelHeight: CGFloat = 11
    
    var yLabelHeight: CGFloat = 30
    ...
    var yChartLabelWidth: CGFloat = 20
    ...
    var barBackgroundColor =   UIColor(red: 77.0/255.0, green: 216.0/255.0, blue: 122.0/255.0, alpha: 0.5)
    ...
    override init(frame: CGRect) {
        ...
        self.backgroundColor =   UIColor(red: 77.0/255.0, green: 216.0/255.0, blue: 122.0/255.0, alpha: 1.0)
    ...
    func strokeChart() {
        ...
        for value in self.yValues {
            ...
            if self.barWidth != nil && self.barWidth > 0 {
                let vke = self.yChartLabelWidth + self.chartMargin
                let gve = (self.xLabelWidth / 2) - (self.barWidth / 2)
                barXPosition = CGFloat(index) * self.xLabelWidth +  vke  + gve
            } else {
            ...
            if self.strokeColor != UIColor.black {
                    if value > 0 && value <= 30 {
                        ...
                        bar.backgroundColor = UIColor(red: 204/255, green: 204/255, blue: 204/255, alpha: 0.3)
                         bar.barColor = UIColor(red: 204/255, green: 204/255, blue: 204/255, alpha: 1)
                    }else if  value > 31 && value <= 50 {
                       
                       bar.backgroundColor = UIColor(red: 255/255, green: 191/255, blue: 0/255, alpha: 0.3)
                        bar.barColor = UIColor(red: 255/255, green: 191/255, blue: 0/255, alpha: 1)
                    }else {
                       
                       bar.backgroundColor = UIColor(red: 255/255, green: 51/255, blue: 51/255, alpha: 0.3)
                        bar.barColor = UIColor(red: 255/255, green: 51/255, blue: 51/255, alpha: 1)
                    }
...
extension PNBarChart {
    ...
    func userClickedOnBarChartIndex(barIndex: Int) {
        UserDefaults.standard.set(barIndex, forKey: "index")
        UserDefaults.standard.synchronize()
         NotificationCenter.default.post(name: Notification.Name(rawValue: "click on Bar"), object: nil)
