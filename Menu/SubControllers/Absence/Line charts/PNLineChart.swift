    ...
    func strokeChart() {
        ...
        for lineIndex in 0..<chartData.count {
            ...
            if chartData.color != UIColor.black {
                if valueSum > 0 && valueSum <= 30 {
                    chartLine.strokeColor = UIColor(red: 204/255, green: 204/255, blue: 204/255, alpha: 1).cgColor
                }else if valueSum > 31 && valueSum <= 50 {
                      chartLine.strokeColor = UIColor(red: 255/255, green: 191/255, blue: 0/255, alpha: 1).cgColor
                }else {
                      chartLine.strokeColor = UIColor(red: 255/255, green: 51/255, blue: 51/255, alpha: 1).cgColor
                }
                
                pointLayer.strokeColor = chartData.color.cgColor
            } else {
                chartLine.strokeColor = UIColor.red.cgColor    //PNGreen.cgColor
